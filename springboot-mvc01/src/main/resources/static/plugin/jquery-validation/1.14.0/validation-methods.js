...
$(function(){
    ...
    //自定义验证
    // 判断是否为0/1
    jQuery.validator.addMethod("isBooleanCustom", function(value, element) {       
    	return this.optional(element) || (/^[-\+]?\d+$/.test(value) && parseInt(value)>=0 && parseInt(value)<=1);    
    }, "匹配Boolean类型(只能包含 0 / 1)");
});
